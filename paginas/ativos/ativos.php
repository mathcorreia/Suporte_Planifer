...
<div class="container py-4">
  ...
  <div class="table-responsive">
    <table id="ativosTable" class="table table-bordered table-hover" style="width:100%">
  ...
  function carregarAtivos() {
    $.post('ativos_actions.php', { action: 'get' }, function(data) {
      if (!$.fn.DataTable.isDataTable('#ativosTable')) {
        tabela = $('#ativosTable').DataTable({ responsive: true });
      }
      tabela.clear();
      if (Array.isArray(data)) {
        ...
        alert("Erro ao carregar a lista de ativos. Verifique o console para mais detalhes.");
    });
  }
