...
switch ($action) {
    ...
    case 'get_ativos':
        ...
        // ALTERADO AQUI: Trocado 'Nome_Ativo' por 'Modelo'
        $sql = "SELECT Ativo_TAG, Modelo FROM SGM_Ativos WHERE Ativo_TAG LIKE ? OR Modelo LIKE ? ORDER BY Ativo_TAG ASC";
    ...
    case 'get_open':
        // ALTERADO AQUI: Trocado a.Nome_Ativo por a.Modelo, mantendo o alias para não quebrar o frontend.
        $sql = "SELECT o.OS_ID as os_tag, o.Ativo_TAG as ativo_tag, a.Modelo as nome_ativo, o.Descricao_Servico as descricao_problema, o.Data_Solicitacao as data_criacao, o.Status as status_atual, o.Maquina_Parada as maquina_parada
                FROM SGM_OS o
                LEFT JOIN SGM_Ativos a ON o.Ativo_TAG = a.Ativo_TAG
                WHERE o.Data_Fim_Atendimento IS NULL
                ORDER BY o.Maquina_Parada DESC, o.Data_Solicitacao ASC";
    ...
    // O restante do seu código PHP que não precisa de alteração...
    case 'create':
